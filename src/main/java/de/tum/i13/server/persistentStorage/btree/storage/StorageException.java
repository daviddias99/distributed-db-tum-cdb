...
/**
 * An {@link Exception} that signalizes that something went wrong in persistent storage
...
public class StorageException extends Exception {
  ...
  /**
   * Creates a new {@link StorageException} with the supplied format string and objects
   *
  ...
  /**
   * Creates a new {@link StorageException} with the supplied format string and objects, and a cause
   *
   * @param format the string to format
   * @param args the parameters for the string formatting
   * @param cause the cause of the exception
