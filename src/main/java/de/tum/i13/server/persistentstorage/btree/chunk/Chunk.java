...
public interface Chunk<V> extends Serializable {
     ...
     */
    int findIndexOfFirstGreaterOrEqualThen(String key);
     ...
     * @return index of first element with a key greater than {@code key}
     */
    int findIndexOfFirstGreaterThen(String key);
     ...
     */
    Pair<V> set(int index, Pair<V> element);
     ...
     */
    void shiftRightOne(int startIndex);
     ...
     */
    void shiftLeftOne(int startIndex);
     ...
     */
    int shiftRightOneAfterFirstGreaterThan(String key);
