...
public class Config extends BaseConfig {
     ...
     */
    @CommandLine.Option(names = "-p", description = "sets the port of the server. Default: ${DEFAULT-VALUE}",
            defaultValue = "5153")
    public int port;
     ...
     */
    @CommandLine.Option(names = "-a", description = "which address the server should listen to. Default: " +
            "${DEFAULT-VALUE}", defaultValue = "127.0.0.1")
    public String listenAddress;

    /**
     * address:port of the ECS server
     */
    @CommandLine.Option(names = "-b", description = "bootstrap broker where clients and other brokers connect first " +
     ...
     */
    @CommandLine.Option(names = "-d", description = "Directory for files. Default: ${DEFAULT-VALUE}", defaultValue =
            "data/")
    public Path dataDir;
     ...
     * Directory for logs
     */
    @CommandLine.Option(names = "-l", description = "Logfile. Default: ${DEFAULT-VALUE}", defaultValue = "logs/server" +
            ".log")
    public Path logfile;
     ...
     * Log leve
     */
    @CommandLine.Option(names = "-ll", description = "Log level. Default: ${DEFAULT-VALUE}. Valid values: " +
            "${COMPLETION-CANDIDATES}", defaultValue = "ALL", converter = LogLevelConverter.class)
    public StandardLevel logLevel;

    /**
     * Size in elements of the cache
     */
    @CommandLine.Option(names = "-c", description = "Size of the cache, e.g., 100 keys. Default: ${DEFAULT-VALUE}",
            defaultValue = "100")
     ...
     * Number of replicas
     */
    @CommandLine.Option(names = "-r", description = "Number of replicas of each element. Default: ${DEFAULT-VALUE}",
            defaultValue = "0")
     ...
     * Caching strategy
     */
    @CommandLine.Option(names = "-s", description = "Cache displacement strategy. Default: ${DEFAULT-VALUE}",
            defaultValue = "FIFO")
    ...
    @CommandLine.Option(names = {"-t",
            "-bTreeMinDegree"}, description = "Minimum degree used by the BTree Persistent storage. Each BTree node " +
            "stores 2*minimumDegree - 1 values.", defaultValue = "15"
