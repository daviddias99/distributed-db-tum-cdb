...
public class HandoffHandler implements Runnable {
     ...
     */
    public HandoffHandler(NetworkLocation peer, String lowerBound, String upperBound, PersistentStorage storage,
                          ChordServerState state, HashingAlgorithm hashingAlgorithm) {
    ...
    public void run() {
        ...
        NetworkPersistentStorage netPeerStorage = new WrappingPersistentStorage(new CommunicationClient(),
                WrappingPersistentStorage.MessageMode.SERVER_OWNER);
