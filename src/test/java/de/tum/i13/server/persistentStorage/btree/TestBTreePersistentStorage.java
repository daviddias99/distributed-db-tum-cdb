...
public class TestBTreePersistentStorage {
  ...
  void putReturnsCorrectKeysAndValues() throws PutException {
    assertThat(storage.put("myKey", "myValue")).extracting(KVMessage::getKey, KVMessage::getValue, KVMessage::getStatus)
        .containsExactly("myKey", "myValue", KVMessage.StatusType.PUT_SUCCESS);
    assertThat(storage.put("myKey2", "myValue2")).extracting(KVMessage::getKey, KVMessage::getValue, KVMessage::getStatus)
